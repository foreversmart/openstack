...
func Test_All_Endpoint(t *testing.T) {
	...
	assertion.Equal(apiv3.APIString("GET /endpoints.endpoints.0.interface"), endpoints[0].Interface)
...
func Test_Show_Endpoint(t *testing.T) {
	...
	assertion.Equal(apiv3.APIString("GET /endpoints/:id.endpoint.interface"), endpoint.Interface)
...
func Test_Update_Endpoint(t *testing.T) {
	...
	assertion.Equal(apiv3.APIString("PATCH /endpoints/:id.endpoint.interface"), endpoint.Interface)
